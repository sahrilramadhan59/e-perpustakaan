        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <div class="card">
                        <div class="card-header col-md-12 col-xs-2">
                            <h3 class="card-title">Tabel Data Penerbit Buku</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo strip_tags($pecah['nama_penerbit']); ?></td>
                                            <td>
                                                <img src="../foto_penerbit/<?php echo strip_tags($pecah['foto_penerbit']); ?>" width="100">
                                            </td>
                                            <td>
                                                <a href="index.php?halaman=hapus_penerbit&id=<?php echo encrypt(strip_tags($pecah['id_penerbit'])); ?>" class="btn-danger btn"><i class="fas fa-trash"> </i> Hapus </a>
                                                ...
                                                <a href="index.php?halaman=ubah_penerbit&id=<?php echo encrypt(strip_tags($pecah['id_penerbit'])); ?>" class="btn btn-warning"><i class="fas fa-edit"> </i> Ubah</a>
