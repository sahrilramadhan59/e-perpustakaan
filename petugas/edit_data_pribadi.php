                        ...
                        <div class="card card-primary">
                            ...
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Nama</label>
                                        <input type="text" name="nama" class="form-control" value="<?php echo $pecah['nama_petugas']; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Alamat</label>
                                        <textarea name="alamat" cols="30" rows="10" class="form-control"><?php echo $pecah['alamat']; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <img src="../foto_petugas/<?php echo $pecah['foto']; ?>" class="user-image img-size-64">
                                    </div>
                                    <div class="form-group">
                            ...
                            if (isset($_POST["ubah"])) {
                                ...
                                if (!empty($lokasifoto)) { //Jika tidak kosong(ada isiya) fotonya. artinya dalam folder lokasi foto sementara ada 
                                    ...
                                    //Mulai.
                                    move_uploaded_file($lokasifoto, "../foto_petugas/$namafoto"); //Artinya, setelah kita upload foto pada form upload 
                                    ...
                                    //Mulai.
                                    $konek->query("UPDATE petugas SET nama_petugas='$nama_lengkap', no_hp='$no_hp', alamat='$alamat', foto='$namafoto' WHERE id_petugas='$id_petugas'");
                                    ...
                                    $konek->query("UPDATE petugas SET nama_petugas='$nama_lengkap', no_hp='$no_hp', alamat='$alamat' WHERE id_petugas='$id_petugas'"); //Artinya apabila kita mengubah data produk kita, TANPA mengubah fotonya maka script ini yang akan dijalankan.
                                }
                                ...
                                echo "<script>location='index.php?halaman=data_pribadi'</script>"; //Redirect(Melakukan) Kembali ke Halaman Produk.
                            }
                            ?>
                        </div>
                        <!-- /.card -->
