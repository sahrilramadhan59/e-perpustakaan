...
<?php
$id_penerbit = decrypt(strip_tags($_GET["id"]));
$ambil_penerbit = $konek->query("SELECT * FROM penerbit WHERE id_penerbit = '$id_penerbit'");
$pecah_penerbit = $ambil_penerbit->fetch_assoc();
?>
<div class="wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Form Ubah Penerbit</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Form Ubah Penerbit</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_Penerbit" class="form-control" value="<?php echo strip_tags($pecah_penerbit['nama_penerbit']) ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>No Hp</label>
                                        <input type="text" name="no_hp" class="form-control" min="1" value="<?php echo strip_tags($pecah_penerbit['no_hp']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Alamat</label>
                                        <textarea name="alamat" id="" cols="30" rows="10" class="form-control"><?php echo strip_tags($pecah_penerbit['alamat']); ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <img src="../foto_penerbit/<?php echo $pecah_penerbit['foto_penerbit']; ?>" class="user-image img-size-64">
                                    </div>
                                    <div class="form-group">
                            ...
                            if (isset($_POST["ubah"])) {
                                ...
                                if (!empty($lokasifoto)) { //Jika tidak kosong(ada isiya) fotonya. artinya dalam folder lokasi foto sementara ada 
                                    ...
                                    //Mulai.
                                    move_uploaded_file($lokasifoto, "../foto_penerbit/$namafoto"); //Artinya, setelah kita upload foto pada form upload 
                                    ...
                                    //Mulai.
                                    $konek->query("UPDATE penerbit SET nama_penerbit='$nama_Penerbit', no_hp='$no_hp', alamat='$alamat', foto_penerbit='$namafoto' WHERE id_penerbit='$id_penerbit'");
                                    ...
                                    $konek->query("UPDATE penerbit SET nama_penerbit='$nama_Penerbit', no_hp='$no_hp', alamat='$alamat' WHERE id_penerbit='$id_penerbit'"); //Artinya apabila kita mengubah data produk kita, TANPA mengubah fotonya maka script ini yang akan dijalankan.
                                }
                                echo "<script>alert('Terima Kasih, Data Penerbit Berhasil Di Perbarui')</script>"; //Tampilkan Notifikasi Berhasil di update.
                                echo "<script>location='index.php?halaman=penerbit_buku'</script>"; //Redirect(Melakukan) Kembali ke Halaman Produk.
                            }
                            ?>
                        </div>
                        <!-- /.card -->
