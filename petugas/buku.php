                ...
                <tbody>
                  ...
                  <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="index.php?halaman=hapusbuku&id=<?php echo encrypt($pecah['id_buku']); ?>" class="btn-danger btn"><i class="fas fa-trash"> </i> Hapus </a>
                        ...
                        <a href="index.php?halaman=ubahbuku&id=<?php echo encrypt($pecah['id_buku']); ?>" class="btn btn-warning"><i class="fas fa-edit"> </i> Ubah</a>
