                                ...
                                <tbody>
                                    ...
                                    <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="index.php?halaman=hapus_pengarang&id=<?php echo encrypt(strip_tags($pecah['id_pengarang'])); ?>" class="btn-danger btn"><i class="fas fa-trash"> </i> Hapus </a>
                                                ...
                                                <a href="index.php?halaman=ubah_pengarang&id=<?php echo encrypt(strip_tags($pecah['id_pengarang'])); ?>" class="btn btn-warning"><i class="fas fa-edit"> </i> Ubah</a>
