<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                                ...
                                <tbody>
                                    ...
                                    <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="index.php?halaman=hapus_kategori&id=<?php echo encrypt($pecah['id_kategori']); ?>" class="btn-danger btn"><i class="fas fa-trash"> </i> Hapus </a>
                                                ...
                                                <a href="index.php?halaman=ubah_kategori&id=<?php echo encrypt($pecah['id_kategori']); ?>" class="btn btn-warning"><i class="fas fa-edit"> </i> Ubah</a>
            ...
            <a href="index.php?halaman=tambah_kategori" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>
            <!-- /.row -->
        </section>
        <!-- /.content -->
    </div>
