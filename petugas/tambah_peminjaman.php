                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="anggota" class="form-control">
                                            ...
                                            <?php $ambil_anggota = $konek->query("SELECT * FROM tb_anggota"); ?>
                                            <?php while ($pecah_anggota = $ambil_anggota->fetch_assoc()) { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="buku" class="form-control">
                                            <option value="">----Pilih-------</option>
                                            <?php $ambil_buku = $konek->query("SELECT * FROM buku"); ?>
                                            <?php while ($pecah_buku = $ambil_buku->fetch_assoc()) { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kategori" class="form-control">
                                            <option value="">----Pilih-------</option>
                                            <?php $ambil_kategori = $konek->query("SELECT * FROM kategori"); ?>
                                            <?php while ($pecah_kategori = $ambil_kategori->fetch_assoc()) { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="petugas" class="form-control">
                                            <option value="">----Pilih-------</option>
                                            <?php $ambil = $konek->query("SELECT * FROM petugas WHERE id_akses='5'"); ?>
                            ...
                            if (isset($_POST["simpan"])) {
                                ...
                                $petugas = strip_tags($_POST["petugas"]);
                                $penerbit = strip_tags($_POST["penerbit"]);
                                $pengarang = strip_tags($_POST["pengarang"]);
                                //1. Masukan Dulu Ke Tabel Peminjamannya Dengan Kode Pinjamnnya.
                                $konek->query("INSERT INTO peminjaman(id_anggota, id_buku, id_kategori, id_petugas, id_penerbit, id_pengarang, tgl_pinjam, tgl_kembali, jumlah)
                                VALUES('$anggota','$buku','$kategori','$petugas','$penerbit','$pengarang','$tgl_pinjam','$tgl_kembali','$jumlah')");

                                //2. Mendapatkan kode_pinjam yang baru saja terjadi.
                                $kode_peminjaman_barusan = $konek->insert_id;

                                // 3.Mendapatkan data produk berdasarkan id_produk.
                                $konek->query("INSERT INTO detail_peminjaman(kode_pinjam, id_buku, id_penerbit, id_pengarang, id_anggota, id_petugas, id_kategori)
                                VALUES('$kode_peminjaman_barusan','$buku','$penerbit','$pengarang','$anggota','$petugas','$kategori')");
