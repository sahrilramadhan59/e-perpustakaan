    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./">Login Petugas Dengan QR Code</a>
            </div>
        </div>
    </nav>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="panel panel-warning">
                    ...
                    <div class="panel-footer">
                        <center><a class="btn btn-warning" href="../login.php">Kembali</a></center>
                    </div>
                </div>
            </div>
        </div>
