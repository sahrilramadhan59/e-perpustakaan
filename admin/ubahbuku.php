...
$id_buku = decrypt(strip_tags($_GET["id"])); //Mengambil data buku berdasarkan id_buku.
$ambil_buku = $konek->query("SELECT * FROM buku INNER JOIN penerbit ON buku.id_penerbit=penerbit.id_penerbit
                                            ...
                                            INNER JOIN kategori ON buku.id_kategori=kategori.id_kategori WHERE id_buku = '$id_buku'"); //Membuat relasi dengan INNER JOIN ke tabel lain.
                            ...
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="tahun_buku" class="form-control" value="<?php echo $pecah_buku['tahun_buku'] ?>">
                                    </div>
                                    <div class="form-group">
