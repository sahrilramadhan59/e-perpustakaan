                        ...
                        <div class="card card-primary">
                            ...
                            if (isset($_POST["ubah"])) {
                                ...
                                if (!empty($lokasifoto)) { //Jika tidak kosong(ada isiya) fotonya. artinya dalam folder lokasi foto sementara ada 
                                    ...
                                    //Mulai.
                                    $konek->query("UPDATE tb_admin SET nama='$nama_lengkap', tingkatan_admin='$tingkatan_admin', foto='$namafoto' WHERE id_admin='$id_admin'");
                                    ...
                                    $konek->query("UPDATE tb_admin SET nama='$nama_lengkap', tingkatan_admin='$tingkatan_admin' WHERE id_admin='$id_admin'"); //Artinya apabila kita mengubah data produk kita, TANPA mengubah fotonya maka script ini yang akan dijalankan.
                                }
