                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Data Pengarang Buku</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tabel Data Pengarang Buku</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo strip_tags($pecah['nama_pengarang']); ?></td>
                                            <td><?php echo strip_tags($pecah['no_hp']); ?></td>
                                            <td><?php echo strip_tags($pecah['alamat']); ?></td>
                                            <td>
                                                <img src="../foto_pengarang/<?php echo strip_tags($pecah['foto_pengarang']); ?>" width="100">
                                            </td>
                                            <td>
                                                <a href="index.php?halaman=hapus_pengarang&id=<?php echo base64_encode(strip_tags($pecah['id_pengarang'])); ?>" class="btn-danger btn"><i class="fas fa-trash"> </i> Hapus </a>
                                                ...
                                                <a href="index.php?halaman=ubah_pengarang&id=<?php echo base64_encode(strip_tags($pecah['id_pengarang'])); ?>" class="btn btn-warning"><i class="fas fa-edit"> </i> Ubah</a>
