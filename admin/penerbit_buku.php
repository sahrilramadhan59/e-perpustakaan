                                ...
                                <tbody>
                                    ...
                                    <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="index.php?halaman=hapus_penerbit&id=<?php echo base64_encode(strip_tags($pecah['id_penerbit'])); ?>" class="btn-danger btn"><i class="fas fa-trash"> </i> Hapus </a>
                                                ...
                                                <a href="index.php?halaman=ubah_penerbit&id=<?php echo base64_encode(strip_tags($pecah['id_penerbit'])); ?>" class="btn btn-warning"><i class="fas fa-edit"> </i> Ubah</a>
