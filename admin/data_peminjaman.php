                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php $ambil = $konek->query("SELECT * FROM peminjaman INNER JOIN buku ON buku.id_buku=peminjaman.id_buku 
                                    ...
                                    <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo strip_tags($pecah['nama_kategori']); ?></td>
                                            <td><?php echo strip_tags($pecah['nama_anggota']); ?></td>
                                            <td><?php echo strip_tags($pecah['jumlah']); ?></td>
                                            ...
                                            <td>
                                                <a href="index.php?halaman=hapus_peminjaman&id=<?php echo encrypt(strip_tags($pecah['kode_pinjam'])); ?>" class="btn-danger btn"><i class="fas fa-trash"> </i> Hapus </a>
                                                <a href="index.php?halaman=detail_peminjaman&id=<?php echo encrypt(strip_tags($pecah['kode_pinjam'])); ?>" class="btn btn-warning"><i class="fas fa-edit"> </i> Detail</a>
